...
streamName = name
filename = streamName + today + ".mp4a"
...
try:
    ...
    tempfilename = filename.replace(".mp4a", "a.mp4a")
    os.replace(filename, tempfilename)
    title = filename.replace(".mp4a", "")
...
#recording.export("new" + filename, format="", bitrate="64k", tags=tags)
